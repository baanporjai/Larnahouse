...
const I18N = {
  ...
  sp1_title:   { th: "เมนูที่หมดก่อนใครในทุกปีใหม่", en: "The Dish That Always Ran Out First", zh: "每年新年最先被吃光的一道菜", ko: "매년 설날마다 가장 먼저 동나던 케이크" },
  sp1_p1:      { th: "สูตรเค้กช็อกโกแลตหน้านิ่มของเรา มาจากคุณแม่ของสามีคุณนภัสพร ผลเจริญ หนึ่งในผู้ก่อตั้ง Larna House เดิมทีเป็นเมนูที่ทำรับประทานกันในครอบครัวช่วงเทศกาลปีใหม่ทุกปี และเป็นเมนูพิเศษที่ทุกคนเฝ้ารอ มักหมดก่อนเมนูอื่นเสมอ", en: "Our soft-fudge chocolate cake recipe came from the mother of Napatsorn Poncharoen's husband, one of Larna House's founders. It was originally a family dish made every New Year — a special treat everyone looked forward to, and always the first to disappear from the table.", zh: "我们的软心巧克力蛋糕食谱，来自Larna House创始人之一——纳帕颂（Napatsorn Poncharoen）丈夫的母亲。这原本是每年新年家庭聚会的特别菜肴，也是大家最期待、总是最先被吃光的一道甜点。", ko: "우리의 소프트 퍼지 초콜릿 케이크 레시피는 Larna House 공동 창업자 나팟손 폰차른(Napatsorn Poncharoen)의 시어머니에게서 전해졌습니다. 원래는 매년 설날마다 가족이 함께 만들어 먹던 특별한 케이크로, 늘 가장 먼저 동이 나던 메뉴였죠." },
  sp1_p2:      { th: "อยากให้คนอื่นได้ลองชิมบ้าง คุณนภัสพรจึงทดลองนำไปวางขายที่ร้านกาแฟตั้งแต่สมัยเรียนมหาวิทยาลัย ผลตอบรับดีเกินคาด จนตัดสินใจเปิดร้านเค้กของตัวเองขึ้นในย่านพัฒนาการเมื่อกว่า 20 ปีก่อน โดยขายเฉพาะเค้กช็อกโกแลตหน้านิ่มเป็นหลัก", en: "Wanting others to try it too, Napatsorn first sold it at a coffee shop while still in university. The response was better than expected, and it eventually led her to open her own cake shop in the Phatthanakan area over 20 years ago — selling almost nothing but soft-fudge chocolate cake.", zh: "为了让更多人也能尝到这份美味，纳帕颂在大学时期就尝试将蛋糕拿到咖啡店寄卖，反响出乎意料地好。20多年前，她便在Phatthanakan街区开设了自己的蛋糕店，几乎只专注于这一款软心巧克力蛋糕。", ko: "더 많은 사람에게 맛보이고 싶었던 나팟손은 대학生 시절 커피숍에 이 케이크를 가져다 놓고 팔아보았습니다. 반응은 기대 이상이었고, 20여 년 전 파타나칸 지역에 자신만의 케이크 가게를 열게 되었습니다. 처음부터 거의 소프트 퍼지 초콜릿 케이크 하나에만 집중했죠." },
  sp1_quote:   { th: "เป็นสูตรที่ได้มาจากคุณแม่ของสามี ปกติทำรับประทานกันในครอบครัวช่วงปีใหม่ทุกปี เป็นเมนูพิเศษที่ทุกคนต่างเฝ้ารอ และมักจะหมดก่อนเมนูอื่นๆ เสมอ", en: "It's a recipe from my husband's mother. We normally made it as a family every New Year — everyone's special, most-anticipated dish, and it always ran out before anything else.", zh: "这是我丈夫母亲传下来的食谱。我们家每年新年都会一起做，是大家最期待的特别菜肴，也总是最先被吃光。", ko: "남편 어머니께 전수받은 레시피예요. 매년 설날마다 가족이 함께 만들었던, 모두가 가장 기다리던 특별한 메뉴였고 늘 가장 먼저 동이 났죠." },
  ...
  sp_source: { th: "เรียบเรียงจากบทสัมภาษณ์คุณนภัสพร ผลเจริญ ผู้ก่อตั้ง Larna House โดย SME Thailand Club", en: "Adapted from an interview with Napatsorn Poncharoen, founder of Larna House, by SME Thailand Club.", zh: "内容改编自SME Thailand Club对Larna House创始人纳帕颂·蓬扎伦的专访。", ko: "SME Thailand Club의 Larna House 창업자 나팟손 폰차른 인터뷰를 바탕으로 재구성했습니다." }
};
