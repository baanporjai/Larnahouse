...
const I18N = {
  ...
  vending_location:{ th: "📍 จัดจำหน่ายแล้วที่เซ็นทรัล เฟสติวัล เชียงใหม่", en: "📍 Now at Central Festival Chiang Mai", zh: "📍 现已入驻清迈 Central Festival", ko: "📍 현재 센트럴 페스티벌 치앙마이에서 만나보세요" },
  ...
  vending_ic2v:    { th: "สแกน QR เท่านั้น", en: "QR Code Only", zh: "仅支持扫码支付", ko: "QR 코드 결제만 가능" },
  ...
  faq5_a:          { th: "หาซื้อได้ที่ตู้ vending machine Frozen Larna Cake ที่เซ็นทรัล เฟสติวัล เชียงใหม่ สอบถามข้อมูลเพิ่มเติมผ่าน LINE @baanporjai", en: "Find us at the Frozen Larna Cake vending machine at Central Festival Chiang Mai. Reach out via LINE @baanporjai for more information.", zh: "您可以在清迈Central Festival的Frozen Larna Cake自助售货机找到我们。如需更多信息，请通过LINE @baanporjai联系。", ko: "센트럴 페스티벌 치앙마이의 Frozen Larna Cake 자판기에서 만나보실 수 있습니다. 자세한 내용은 LINE @baanporjai로 문의해주세요." },
  ...
  faq7_a:          { th: "ตู้ Frozen Larna Cake รองรับการชำระเงินผ่าน QR Code เท่านั้น ได้แก่ PromptPay, TrueMoney, Alipay และ WeChat Pay — ไม่มีช่องรับเงินสดหรือเหรียญ", en: "Our vending machines accept QR code payments only — PromptPay, TrueMoney, Alipay, and WeChat Pay. There is no slot for cash or coins.", zh: "我们的自助售货机仅支持扫码支付，包括 PromptPay、TrueMoney、支付宝和微信支付——不设现金或硬币投入口。", ko: "자판기는 QR 코드 결제만 지원합니다 — PromptPay, TrueMoney, Alipay, WeChat Pay. 현금이나 동전 투입구는 없습니다." },
  ...
  footer_about:    { th: "Frozen Larna Cake โดย Larna House — เค้กไอศกรีมช็อกโกแลตไทยแช่แข็ง อร่อยได้นาน อร่อยได้ทุกที่ จัดจำหน่ายผ่านตู้ vending machine ที่เซ็นทรัล เฟสติวัล เชียงใหม่ ได้แล้ว", en: "Frozen Larna Cake by Larna House — Thai chocolate ice cream cake, frozen for freshness, delicious anywhere. Now available through our vending machine at Central Festival Chiang Mai.", zh: "Larna House旗下的Frozen Larna Cake——泰式巧克力冰淇淋蛋糕，冷冻保鲜，随时随地享用。现已在清迈Central Festival的自助售货机上架。", ko: "Larna House의 Frozen Larna Cake — 태국 초콜릿 아이스크림 케이크. 신선함을 오래 유지하며 언제 어디서나 맛볼 수 있습니다. 현재 센트럴 페스티벌 치앙마이의 자판기에서 만나보실 수 있습니다." },
